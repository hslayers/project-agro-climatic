    ...
    layers: {
        ...
        frostPeriod
            ...
            LGPC3: new VectorLayer({
                source: new VectorSource(), title: 'LGP for C3 crops [in days]', exclusive: true, abstract: `LGP stands for Length of Growing Period and is calculated as a sum of days when the average temperature is in between the absolute minimum and the absolute maximum of the selected crop.
            ...
            LGPC4: new VectorLayer({
                source: new VectorSource(), title: 'LGP for C4 crops [in days]', exclusive: true, abstract: `LGP stands for Length of Growing Period and is calculated as a sum of days when the average temperature is in between the absolute minimum and the absolute maximum of the selected crop.
            ...
            LOGPC3: new VectorLayer({
                source: new VectorSource(), title: 'LOGP for C3 crops [in days]', exclusive: true, abstract: `LOGP stands for Length of Optimal Growing Period and it is calculated as a sum of days when the average daily temperature is at the best temperatures for crop growth, between the optimal minimum and optimal maximum of the selected crop.
            ...
            LOGPC4: new VectorLayer({
                source: new VectorSource(), title: 'LOGP for C4 crops [in days]', exclusive: true, abstract: `LOGP stands for Length of Optimal Growing Period and it is calculated as a sum of days when the average daily temperature is at the best temperatures for crop growth, between the optimal minimum and optimal maximum of the selected crop.
